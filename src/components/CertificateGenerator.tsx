          ...
          {isGenerating ? <div className="text-center py-12">
              ...
              <div className="relative z-10">
                ...
                <div className="text-center border-b pb-6">
                  {companyConfig?.logoUrl ? <img src={companyConfig.logoUrl} alt="Logo" className="h-20 w-auto mx-auto mb-4" /> : <img src="/lovable-uploads/09667bc0-9af8-468b-9c4c-d4844d158bc0.png" alt="Vity Logo" className="h-36 w-auto mx-auto mb-4" />}
